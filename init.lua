...
require('lazy').setup({
  ...
  },
  {
    ...
    config = function()
      ...
      -- Manually setup each LSP server after mason-lspconfig ensures they're installed
  ...
  { -- You can easily change to a different colorscheme.
    ...
    config = function()
      ...
      -- any other, such as 'catppuccin-mocha', 'catppuccin-frappe', 'catppuccin-latte', or 'catppuccin-macchiato'.
